"""
learner.py — Central Recurrent-PPO learner for single_agent_olympus.
...
Usage (started by orchestrator):
  python single_agent_olympus/algorithms/recurrent_ppo/learner.py \\
...
from single_agent_olympus.algorithms.recurrent_ppo.model import (
