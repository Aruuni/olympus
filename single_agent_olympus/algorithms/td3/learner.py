"""
learner.py — recurrent TD3 learner for single_agent_olympus.
...
Usage (started by orchestrator):
  python single_agent_olympus/algorithms/td3/learner.py \
...
from single_agent_olympus.algorithms.td3.model import (
