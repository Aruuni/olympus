...
Each algorithm can override states in:
  single_agent_olympus.algorithms.<algorithm>.states.<state_name>

Otherwise the loader falls back to shared states in:
  single_agent_olympus.states.<state_name>
...
def load_state_module(algorithm: str, state_name: str = None):
    ...
    module_names = [
        f'single_agent_olympus.algorithms.{algorithm}.states.{state_name}',
        f'single_agent_olympus.states.{state_name}',
    ]
