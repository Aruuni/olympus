...
Example:
  ./venv_training/bin/python olympus/plot_random_bw_runs.py \\
    olympus/data/random_bw_rtt_goodput_single_20260501-022552
"""
...
def _latest_run_dir():
    pattern = os.path.join(
        _ROOT, 'olympus', 'data', 'random_bw_rtt_goodput_single_*')
